...
/* harmony import */ var _categoriesList__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./categoriesList */ "./src/app/categoriesList/categoriesList.ts");
...
let CategoriesList = class CategoriesList {
    ...
    ionViewDidEnter() {
        if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].site_details.categoryListTabContent == 1)
            this.tabShown = 1;
        else if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].site_details.categoryListTabContent == 2)
            this.tabShown = 2;
        else
            this.tabShown = 1;
    ...
    getListingsByCategory(selectedCat, typeId) {
        ...
        const category = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].listingCategories.find(cat => cat.slug == selectedCat.slug);
        if (category) {
            _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filtersSearch.categories = [category.name];
            _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filtersSearch.selectedType = typeId;
            // select Listing Type
    ...
    getCategoriesForEachType() {
        _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].listingTypesDetails.forEach(type => {
    ...
    getRegionsForEachType() {
        _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].listingTypesDetails.forEach(type => {
            ...
            if (type.case27_listing_type_search_page && type.case27_listing_type_search_page.advanced
                ...
                this.service.getRegionsByType(type.ID).subscribe((data) => {
                    if (data.success)
    ...
    getListingsByRegion(selectedReg, typeId) {
        _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].clearFilters();
        const region = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].regions.find(cat => cat.slug == selectedReg.slug);
        if (region) {
            console.log(region);
...
CategoriesList = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./categoriesList.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/categoriesList/categoriesList.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./categoriesList.scss */ "./src/app/categoriesList/categoriesList.scss")).default]
    }),
...
//# sourceMappingURL=categoriesList-categoriesList-module-es2015.js.map