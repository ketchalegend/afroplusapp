...
/* harmony import */ var _entities_FiltersSearch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./entities/FiltersSearch */ "./src/app/entities/FiltersSearch.ts");
...
class GlobalFields {
    ...
    static init(service, dialogs, platform, geolocation, nativeGeocoder, alertController, translate, themeService, locationService) {
        console.log('loading');
        this.loading = true;
    ...
    static endOfCalls(goodAPIs, geolocation, nativeGeocoder, alertController, service, locationService) {
        if (goodAPIs == 3) {
            // fine
    ...
    static getListingTypeById(id) {
        const res = GlobalFields.listingTypesDetails.find(temp => temp.ID == id);
        return res;
    }
    static getListingTypeTitleById(id) {
        const res = GlobalFields.listingTypesDetails.find(temp => temp.ID == id);
        if (res)
            return res.post_title;
        else
    ...
    static getListingTypeTitleBySlug(slug) {
        const res = GlobalFields.listingTypesDetails.find(temp => temp.post_name == slug);
        if (res)
            return res.post_title;
        else
    ...
    static getFilteredListingFirstTime(service, locationService, stats) {
        ...
        if (GlobalFields.filtersSearch.location) { //address
            if (GlobalFields.site_details.mapType == 1) { //Google Maps
                locationService.getMyLatLongFromGoogle(GlobalFields.filtersSearch.location).subscribe((d) => {
                ...
                locationService.getLatLongFromOpenMaps(GlobalFields.filtersSearch.location).subscribe((data) => {
                    console.log(data);
    ...
    static getImgFeaturedListing(listings, service) {
        if (listings) {
            for (let i = 0; i < listings.length; i++) {
                service.getListingCoverDetails(listings[i]._links['wp:attachment'][0].href).subscribe((data) => {
                    if (data && data.length > 0) {
    ...
    static getLatLongFromAddress(locationService, address) {
        if (GlobalFields.site_details.mapType == 1) {
            locationService.getMyLatLongFromGoogle(address).subscribe((data) => {
            ...
            locationService.getLatLongFromOpenMaps(address).subscribe((data) => {
                console.log(data);
                if (data && data.length > 0) {
...
GlobalFields.oldReview = undefined;
//app status part
...
/* harmony import */ var _tabs_modalAdd_modalAdd__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tabs/modalAdd/modalAdd */ "./src/app/tabs/modalAdd/modalAdd.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var ionic_cache__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ionic-cache */ "./node_modules/ionic-cache/__ivy_ngcc__/dist/index.js");
...
/* harmony import */ var _services_LocationService__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services/LocationService */ "./src/app/services/LocationService.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, router, splashScreen, statusBar, service, dialogs, modalCtrl, cache, geolocation, nativeGeocoder, alertController, translate, themeService, locationService, storage, navCtrl) {
    ...
    initializeApp() {
        this.platform.ready().then(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.statusBar.hide();
            this.stateValue = yield this.storage.get('onboarding');
...
AppComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"],
        ...
        _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], ionic_cache__WEBPACK_IMPORTED_MODULE_10__["CacheService"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_11__["Geolocation"],
        _ionic_native_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_12__["NativeGeocoder"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"],
        _ngx_translate_core__WEBPACK_IMPORTED_MODULE_13__["TranslateService"], _services_theme_service__WEBPACK_IMPORTED_MODULE_14__["ThemeService"],
        _services_LocationService__WEBPACK_IMPORTED_MODULE_15__["LocationService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_16__["Storage"],
...
/* harmony import */ var _tabs_modalAdd_modalAdd__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./tabs/modalAdd/modalAdd */ "./src/app/tabs/modalAdd/modalAdd.ts");
/* harmony import */ var _home_modalPost_modalPost__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./home/modalPost/modalPost */ "./src/app/home/modalPost/modalPost.ts");
/* harmony import */ var _listingPage_listingPage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./listingPage/listingPage */ "./src/app/listingPage/listingPage.ts");
/* harmony import */ var _searchPage_filterModal_filterModal__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./searchPage/filterModal/filterModal */ "./src/app/searchPage/filterModal/filterModal.ts");
/* harmony import */ var _home_popoverSearch_popoverSearch__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./home/popoverSearch/popoverSearch */ "./src/app/home/popoverSearch/popoverSearch.ts");
...
/* harmony import */ var _searchPage_search_module__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./searchPage/search.module */ "./src/app/searchPage/search.module.ts");
...
/* harmony import */ var _listingPage_popoverRatings_popoverRatings__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./listingPage/popoverRatings/popoverRatings */ "./src/app/listingPage/popoverRatings/popoverRatings.ts");
/* harmony import */ var _listingPage_popoverImg_popoverImg__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./listingPage/popoverImg/popoverImg */ "./src/app/listingPage/popoverImg/popoverImg.ts");
/* harmony import */ var _sideMenu_sideMenu__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./sideMenu/sideMenu */ "./src/app/sideMenu/sideMenu.ts");
/* harmony import */ var _listingPage_modalWriteReview_modalWriteReview__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./listingPage/modalWriteReview/modalWriteReview */ "./src/app/listingPage/modalWriteReview/modalWriteReview.ts");
...
/* harmony import */ var _listingList_listingList__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./listingList/listingList */ "./src/app/listingList/listingList.ts");
...
/* harmony import */ var _listingList_customFieldsToDisplay_customFieldsToDisplay__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./listingList/customFieldsToDisplay/customFieldsToDisplay */ "./src/app/listingList/customFieldsToDisplay/customFieldsToDisplay.ts");
...
/* harmony import */ var _home_modalGenericSearch_modal_generic_search_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./home/modalGenericSearch/modal-generic-search.component */ "./src/app/home/modalGenericSearch/modal-generic-search.component.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _tabs_modalAdd_modalAdd__WEBPACK_IMPORTED_MODULE_9__["ModalAddNode"],
            _home_modalPost_modalPost__WEBPACK_IMPORTED_MODULE_10__["ModalPost"],
            _listingPage_listingPage__WEBPACK_IMPORTED_MODULE_11__["ListingPage"],
            _sideMenu_sideMenu__WEBPACK_IMPORTED_MODULE_34__["SideMenu"],
            _listingPage_popoverRatings_popoverRatings__WEBPACK_IMPORTED_MODULE_32__["PopoverRatings"],
            _listingPage_modalWriteReview_modalWriteReview__WEBPACK_IMPORTED_MODULE_35__["ModalWriteReview"],
            _listingPage_popoverImg_popoverImg__WEBPACK_IMPORTED_MODULE_33__["PopoverImg"],
            _searchPage_filterModal_filterModal__WEBPACK_IMPORTED_MODULE_12__["FilterModal"],
            _home_popoverSearch_popoverSearch__WEBPACK_IMPORTED_MODULE_13__["PopoverSearch"],
            _home_modalGenericSearch_modal_generic_search_component__WEBPACK_IMPORTED_MODULE_48__["ModalGenericSearch"]
        ],
        entryComponents: [
            _listingPage_listingPage__WEBPACK_IMPORTED_MODULE_11__["ListingPage"],
            _sideMenu_sideMenu__WEBPACK_IMPORTED_MODULE_34__["SideMenu"],
            ...
            _home_popoverSearch_popoverSearch__WEBPACK_IMPORTED_MODULE_13__["PopoverSearch"],
            _tabs_modalAdd_modalAdd__WEBPACK_IMPORTED_MODULE_9__["ModalAddNode"],
            _listingList_listingList__WEBPACK_IMPORTED_MODULE_38__["ListingList"],
            _listingList_customFieldsToDisplay_customFieldsToDisplay__WEBPACK_IMPORTED_MODULE_43__["CustomFieldsToDisplay"],
            _home_modalGenericSearch_modal_generic_search_component__WEBPACK_IMPORTED_MODULE_48__["ModalGenericSearch"]
        ],
        imports: [
            ...
            _home_home_module__WEBPACK_IMPORTED_MODULE_28__["HomePageModule"],
            _searchPage_search_module__WEBPACK_IMPORTED_MODULE_29__["SearchPageModule"],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FiltersSearch", function() { return FiltersSearch; });
class WorkHoursDay {
    constructor() {
...
/* harmony import */ var _FiltersSearch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./FiltersSearch */ "./src/app/entities/FiltersSearch.ts");
...
/* harmony import */ var _home__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./home */ "./src/app/home/home.ts");
...
/* harmony import */ var _utilities_utilities_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utilities/utilities.module */ "./src/app/utilities/utilities.module.ts");
/* harmony import */ var _postsPage_postsPage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./postsPage/postsPage */ "./src/app/home/postsPage/postsPage.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _listingPage_listingPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../listingPage/listingPage */ "./src/app/listingPage/listingPage.ts");
/* harmony import */ var _app_Constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../app/Constants */ "./src/app/Constants.ts");
/* harmony import */ var _app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../app/GlobalFields */ "./src/app/GlobalFields.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _modalPost_modalPost__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modalPost/modalPost */ "./src/app/home/modalPost/modalPost.ts");
/* harmony import */ var _popoverSearch_popoverSearch__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./popoverSearch/popoverSearch */ "./src/app/home/popoverSearch/popoverSearch.ts");
/* harmony import */ var _services_Service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../services/Service */ "./src/app/services/Service.ts");
...
/* harmony import */ var _modalGenericSearch_modal_generic_search_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modalGenericSearch/modal-generic-search.component */ "./src/app/home/modalGenericSearch/modal-generic-search.component.ts");
...
let HomePage = HomePage_1 = class HomePage {
    constructor(service, locationService, modalCtrl, popoverController, navController, statusBar, platform, nativeGeocoder, _sanitizer, translate, alertController, menu, appVersion) {
    ...
    */
        ...
        for (let i = 0; i < this.GlobalFields.listingTypesDetails.length; i++) {
            ...
            service.getListingsFilteredByType(_app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].listingTypesDetails[i].ID)
                .subscribe((data) => {
    ...
    */
    getListingDetails(listing) {
        ...
        this.service.getListingDetailsById(listing.id).subscribe((data) => {
    ...
    */
    ...
    toStringCategories() {
        if (!_app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.categories || _app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.categories.length == 0)
            return '';
        else if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.categories.length > 3)
            return _app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.categories.length + ' selected';
        else
            return _app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.categories.toString();
    }
    isSelected(id) {
    ...
    toStringTaxonomies(key) {
        let tax = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].getCustomTaxonomiesByKey(key);
        if (tax) {
            return tax.selected;
        }
    }
    toStringCustomFields(key) {
        let tax = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].getCustomFieldsByKey(key);
        if (tax) {
    ...
    toStringRegions() {
        if (!_app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.region)
            return '';
    ...
    getBackgroundBasedOnHomeType() {
        if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].site_details.homeType == 3)
            return _app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].getBodyColorBackgroundJson();
    }
    openSideMenu() {
...
HomePage = HomePage_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'page-home',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./home.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/home/home.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./home.scss */ "./src/app/home/home.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_Service__WEBPACK_IMPORTED_MODULE_8__["Service"], _services_LocationService__WEBPACK_IMPORTED_MODULE_13__["LocationService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["ModalController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["PopoverController"],
...
/* harmony import */ var _listingPage_listingPage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../listingPage/listingPage */ "./src/app/listingPage/listingPage.ts");
...
let ModalGenericSearch = class ModalGenericSearch {
    constructor(viewCtrl, service, navController, locationService, alertController) {
    ...
    generalSearch() {
        this.loading = true;
        this.service.getGeneralSearch(this.searchQuery).subscribe((res) => {
            if (res && res.success) {
    ...
    getListingsByCategory(catName, typeId) {
        ...
        _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.selectedType = typeId;
        // select Listing Type
        this.GlobalFields.selectListingTypeDetail();
        this.closeModal();
        _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].getFilteredListingFirstTime(this.service, this.locationService, true);
...
ModalGenericSearch = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./modal-generic-search.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/home/modalGenericSearch/modal-generic-search.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./modal-generic-search.component.scss */ "./src/app/home/modalGenericSearch/modal-generic-search.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _services_Service__WEBPACK_IMPORTED_MODULE_5__["Service"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _app_entities_post__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../app/entities/post */ "./src/app/entities/post.ts");
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _app_entities_post__WEBPACK_IMPORTED_MODULE_3__["Post"])
], ModalPost.prototype, "post", void 0);
ModalPost = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'modalPost',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./modalPost.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/home/modalPost/modalPost.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./modalPost.scss */ "./src/app/home/modalPost/modalPost.scss")).default]
    }),
...
/* harmony import */ var _GlobalFields__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../GlobalFields */ "./src/app/GlobalFields.ts");
/* harmony import */ var _listingPage_listingPage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../listingPage/listingPage */ "./src/app/listingPage/listingPage.ts");
...
PopoverSearch = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./popoverSearch.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/home/popoverSearch/popoverSearch.html")).default
    }),
...
/* harmony import */ var _services_Service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../services/Service */ "./src/app/services/Service.ts");
/* harmony import */ var _modalPost_modalPost__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../modalPost/modalPost */ "./src/app/home/modalPost/modalPost.ts");
...
PostsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'postsPoage',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./postsPage.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/home/postsPage/postsPage.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./postsPage.scss */ "./src/app/home/postsPage/postsPage.scss")).default]
    }),
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _app_entities_listing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../app/entities/listing */ "./src/app/entities/listing.ts");
/* harmony import */ var _app_Constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../app/Constants */ "./src/app/Constants.ts");
/* harmony import */ var _app_GlobalFields__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../app/GlobalFields */ "./src/app/GlobalFields.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _services_Service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../services/Service */ "./src/app/services/Service.ts");
...
/* harmony import */ var _entities_listingTypeDetail__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../entities/listingTypeDetail */ "./src/app/entities/listingTypeDetail.ts");
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _app_entities_listing__WEBPACK_IMPORTED_MODULE_2__["Listing"])
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _entities_listingTypeDetail__WEBPACK_IMPORTED_MODULE_9__["ListingTypeDetail"])
...
CustomFieldsToDisplay = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./customFieldsToDisplay.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/listingList/customFieldsToDisplay/customFieldsToDisplay.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./customFieldsToDisplay.scss */ "./src/app/listingList/customFieldsToDisplay/customFieldsToDisplay.scss")).default]
    }),
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _listingPage_listingPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../listingPage/listingPage */ "./src/app/listingPage/listingPage.ts");
/* harmony import */ var _app_entities_listing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../app/entities/listing */ "./src/app/entities/listing.ts");
/* harmony import */ var _app_Constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../app/Constants */ "./src/app/Constants.ts");
/* harmony import */ var _app_GlobalFields__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../app/GlobalFields */ "./src/app/GlobalFields.ts");
...
/* harmony import */ var _home_modalPost_modalPost__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../home/modalPost/modalPost */ "./src/app/home/modalPost/modalPost.ts");
...
let ListingList = class ListingList {
    ...
    isWhiteBackgroundBorder() {
        if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_5__["GlobalFields"].isWhiteBackground())
            return '';
        else
            return ' borderList';
    }
    ...
    */
    ...
    getBackground(listing) {
        ...
        if (!listing.img_cover && listing.listing_data && listing.listing_data._job_cover)
            ...
            image = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_5__["GlobalFields"].site_details.placeholderImgUrl;
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _app_entities_listing__WEBPACK_IMPORTED_MODULE_3__["Listing"])
...
ListingList = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./listingList.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/listingList/listingList.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./listingList.scss */ "./src/app/listingList/listingList.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_Service__WEBPACK_IMPORTED_MODULE_7__["Service"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["ModalController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["NavController"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["Platform"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateService"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_10__["DomSanitizer"],
...
/* harmony import */ var _popoverRatings_popoverRatings__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./popoverRatings/popoverRatings */ "./src/app/listingPage/popoverRatings/popoverRatings.ts");
/* harmony import */ var _popoverImg_popoverImg__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./popoverImg/popoverImg */ "./src/app/listingPage/popoverImg/popoverImg.ts");
...
/* harmony import */ var _modalWriteReview_modalWriteReview__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modalWriteReview/modalWriteReview */ "./src/app/listingPage/modalWriteReview/modalWriteReview.ts");
...
let ListingPage = class ListingPage {
    constructor(service, modalCtrl, statusBar, callNumber, platform, launchNavigator, socialSharing, translate, popoverController, _sanitizer, navController, inAppBrowser) {
        this.service = service;
        this.modalCtrl = modalCtrl;
        this.statusBar = statusBar;
    ...
    ini() {
        if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing._case27_listing_type)
            _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedTypeDetail = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].listingTypesDetails.find(res => res.post_name == _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing._case27_listing_type);
        ...
        console.log(_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing);
        ...
        _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.comments.forEach(comm => {
            if (comm.ratings)
                comm.ratings = this.generateArray(comm.ratings);
        });
        //check if is bookmarked
        if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].bookmarkedListings && _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].bookmarkedListings.find(el => el.id == _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.id))
    ...
    getCustomField(key) {
        let res = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing['_' + key];
        if (!res)
            res = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing[key];
        return res;
    }
    fieldToBeShown(key) {
    ...
    isPresentCustomField(key) {
        let a = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing[key];
    ...
    */
    ...
    getCategories() {
        ...
        if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.job_listing_category) {
            _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.job_listing_category.forEach(id => {
                let p = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].getCategoryId(id);
                _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].listingCategories.forEach(cat => {
                    if (cat.id == id) {
                        res.push(cat);
                    }
                });
    ...
    getCustomFields() {
        ...
        let keys = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filterNotCustomFields(Object.keys(_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing));
        this.custFields = [];
        this.custRelatedListings = [];
    ...
    getCustomTaxonomies() {
        let keys = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filterNotCustomTaxonomies(_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.pure_taxonomies);
        this.custTaxonomies = [];
        console.log(keys);
        if (keys && Array.isArray(keys))
            keys.forEach(key => {
                ...
                console.log(listingTypeField);
                if (listingTypeField) {
                    let value = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.pure_taxonomies[key];
                    console.log(value);
                    if (value && value != '')
    ...
    getActionContainerClass() {
        if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].site_details.actionButtonStyle == '2')
    ...
    getCustomFieldTaxonomyOptionByKey(key, optID) {
       ...
       */
        //is a custom field ?
        let field = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filtersSearch.customFieldsDropdownKeysOptions.find(term => term.key == key);
        ...
        //is a taxonomy ?
        field = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filtersSearch.customTaxonomiesDropdownKeysOptions.find(term => term.key == key);
        if (field && field.options) {
            let opt = field.options.find(temp => temp.term_id == optID);
            if (opt) //is not an array
                return opt.name;
    ...
    showContactInfo() {
        //if no data to show
        if ((!_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing || (!_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.job_email && !_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.job_phone &&
            !_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.job_location && !_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.links)))
            return false;
    ...
    getBackground(listing) {
        ...
        if (listing && !listing.img_cover && listing.job_cover)
            ...
            image = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].site_details.placeholderImgUrl;
        return this._sanitizer.bypassSecurityTrustStyle(`url(${image})`);
    }
    getBackgroundDarker(listing) {
        let image = '';
    ...
    doBookmark() {
        ...
        this.service.doBookmark(_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.id).subscribe((data) => {
            _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].loadingSoft = false;
            this.service.getBookmarkedListings().subscribe((data) => {
    ...
    undoBookmark() {
        _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.isBookmarked = false;
        _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].loadingSoft = true;
        this.service.undoBookmark(_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.id).subscribe((data) => {
            _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].loadingSoft = false;
            this.service.getBookmarkedListings().subscribe((data) => {
                _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].bookmarkedListings = data;
            });
    ...
    youAlreadyReviewed() {
        return _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].selectedListing.comments.find(comm => comm.author_id == this.GlobalFields.profile.user.id);
    }
    getImgCachedClass(class_to_add) {
...
ListingPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./listingPage.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/listingPage/listingPage.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./listingPage.scss */ "./src/app/listingPage/listingPage.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_Service__WEBPACK_IMPORTED_MODULE_8__["Service"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
        _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_5__["StatusBar"], _ionic_native_call_number_ngx__WEBPACK_IMPORTED_MODULE_6__["CallNumber"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
        _ionic_native_launch_navigator_ngx__WEBPACK_IMPORTED_MODULE_7__["LaunchNavigator"], _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_9__["SocialSharing"],
        _ngx_translate_core__WEBPACK_IMPORTED_MODULE_11__["TranslateService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["PopoverController"],
        _angular_platform_browser__WEBPACK_IMPORTED_MODULE_14__["DomSanitizer"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_16__["InAppBrowser"]])
], ListingPage);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../app/GlobalFields */ "./src/app/GlobalFields.ts");
...
let ModalWriteReview = class ModalWriteReview {
    constructor(translate, service, statusBar, modalCtrl, navParams, alertController, imagePicker, sanitizer, webview, platform, base64) {
        this.translate = translate;
        this.service = service;
        this.statusBar = statusBar;
        this.modalCtrl = modalCtrl;
            ...
            this.service.postAReview(this.GlobalFields.selectedListing.id, this.comment, this.customFieldsStars, galleryIds, this.new_gallery_File, this.new_gallery_Name).subscribe(() => {
                ...
                setTimeout(() => {
                    this.service.getListingDetailsById(this.GlobalFields.selectedListing.id).subscribe(data => {
                        this.GlobalFields.selectedListing = data;
                        this.GlobalFields.loadingSoft = false;
                        this.service.getFilteredListings().subscribe((data2) => {
...
ModalWriteReview = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./modalWriteReview.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/listingPage/modalWriteReview/modalWriteReview.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./modalWriteReview.scss */ "./src/app/listingPage/modalWriteReview/modalWriteReview.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"], _services_Service__WEBPACK_IMPORTED_MODULE_6__["Service"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_8__["StatusBar"],
...
PopoverImg = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'popoverImg',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./popoverImg.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/listingPage/popoverImg/popoverImg.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./popoverImg.scss */ "./src/app/listingPage/popoverImg/popoverImg.scss")).default]
    }),
...
PopoverRatings = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./popoverRatings.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/listingPage/popoverRatings/popoverRatings.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./popoverRatings.scss */ "./src/app/listingPage/popoverRatings/popoverRatings.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateService"], _services_Service__WEBPACK_IMPORTED_MODULE_5__["Service"]])
], PopoverRatings);
...
let Loading = class Loading {
    constructor(service, dialogs, platform, geolocation, nativeGeocoder, alertController, translate, themeService, locationService) {
        this.service = service;
        this.dialogs = dialogs;
        this.platform = platform;
        this.geolocation = geolocation;
...
Loading = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'loading',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./loading.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/loading/loading.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./loading.scss */ "./src/app/loading/loading.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_Service__WEBPACK_IMPORTED_MODULE_3__["Service"], _ionic_native_dialogs_ngx__WEBPACK_IMPORTED_MODULE_4__["Dialogs"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["Platform"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_6__["Geolocation"],
        ...
        _services_theme_service__WEBPACK_IMPORTED_MODULE_9__["ThemeService"], _services_LocationService__WEBPACK_IMPORTED_MODULE_10__["LocationService"]])
], Loading);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../app/GlobalFields */ "./src/app/GlobalFields.ts");
/* harmony import */ var _app_entities_checkboxType__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../app/entities/checkboxType */ "./src/app/entities/checkboxType.ts");
...
let FilterModal = class FilterModal {
    constructor(service, locationService, modalCrtl, translate, statusBar, modalCtrl, geolocation, nativeGeocoder, alertController) {
        this.service = service;
        this.locationService = locationService;
    ...
    iniFilter() {
        if (!_app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch) {
            ...
            if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch.tags.length == 0)
                this.prepareOptionsTags();
    ...
    prepareOptionsTags() {
        this.GlobalFields.selectedTypeDetail.tags.forEach(cat => {
            let c = new _app_entities_checkboxType__WEBPACK_IMPORTED_MODULE_3__["CheckboxType"]();
            c.isChecked = false;
            c.val = cat;
  ...
  */
    ...
    toStringCategories() {
        if (!_app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch.categories || _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch.categories.length == 0)
            return "";
        else if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch.categories.length > 3)
            return _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch.categories.length + " selected";
        else
            return _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch.categories.toString();
    }
    toStringRegions() {
        if (!_app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch.region)
            return "";
        return _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch.region;
    }
    toStringTaxonomies(key) {
        let tax = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].getCustomTaxonomiesByKey(key);
        if (tax) {
            /* if (!tax.selected || tax.selected.length == 0)
                 return "";
             else if (tax.selected.length > 3)
    ...
    toStringCustomFields(key) {
        let tax = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].getCustomFieldsByKey(key);
        if (tax) {
            /*  if (!tax.selected || tax.selected.length == 0)
                  return "";
              else if (tax.selected.length > 3)
...
FilterModal = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./filterModal.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/searchPage/filterModal/filterModal.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./filterModal.scss */ "./src/app/searchPage/filterModal/filterModal.scss")).default]
    }),
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _listingPage_listingPage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../listingPage/listingPage */ "./src/app/listingPage/listingPage.ts");
/* harmony import */ var _filterModal_filterModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../filterModal/filterModal */ "./src/app/searchPage/filterModal/filterModal.ts");
/* harmony import */ var _services_LocationService__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/LocationService */ "./src/app/services/LocationService.ts");
/* harmony import */ var _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ionic-native/status-bar/ngx */ "./node_modules/@ionic-native/status-bar/ngx/index.js");
...
let MapModal = class MapModal {
    constructor(service, modalCtrl, locationService, statusBar, alertController, plt) {
        this.service = service;
        this.modalCtrl = modalCtrl;
        this.locationService = locationService;
        this.statusBar = statusBar;
    ...
    iniMaps() {
        ...
        else if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].site_details.mapType == 1) // Google Maps
            this.loading = false;
    }
    closeModal() {
        this.modalCtrl.dismiss();
    ...
    getPositions() {
        ...
        let listings = [];
        if (!this.GlobalFields.site_details.showMapAllListings)
            listings = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filteredListings;
        else
        ...
        listings.forEach(listing => {
            if (!isNaN(parseFloat(listing.listing_data.geolocation_lat)) && !isNaN(parseFloat(listing.listing_data.geolocation_long))) {
                this.loading = true;
                //Custom HTML icon
                const typeDetail = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].listingTypesDetails.find(res => res.post_name == listing.listing_data._case27_listing_type);
    ...
    loadData() {
        ...
        if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch.location) { //address
    ...
    callServiceToGetFilteredListings() {
        this.service.getFilteredListings()
            ...
            this.getPositions();
            this.loadingMoreData = false;
            if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filteredListings.length < 10 || data.length == 0)
                _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].filtersSearch.noMorePage = true;
        });
    }
    getAllListings() {
        this.service.getAllListings()
            .subscribe((res) => {
            if (res.success) {
                this.allListings = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].fixWrongImgCoverField(res.data);
                this.getPositions();
                this.iniMaps();
            }
        });
    ...
    getListingImg(listing) {
        ...
        if (!listing.img_cover && listing.listing_data && listing.listing_data._job_cover)
            ...
            image = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_2__["GlobalFields"].site_details.placeholderImgUrl;
        return image;
    }
};
...
MapModal = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'map-filter',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./mapModal.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/searchPage/mapModal/mapModal.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./mapModal.scss */ "./src/app/searchPage/mapModal/mapModal.scss")).default]
    }),
...
/* harmony import */ var _searchPage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./searchPage */ "./src/app/searchPage/searchPage.ts");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/__ivy_ngcc__/fesm2015/ngx-translate-core.js");
/* harmony import */ var _shared_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../shared.module */ "./src/app/shared.module.ts");
/* harmony import */ var _mapModal_mapModal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./mapModal/mapModal */ "./src/app/searchPage/mapModal/mapModal.ts");
/* harmony import */ var _utilities_utilities_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utilities/utilities.module */ "./src/app/utilities/utilities.module.ts");
...
SearchPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["NgModule"])({
        imports: [
            ...
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"],
            _utilities_utilities_module__WEBPACK_IMPORTED_MODULE_10__["UtilitiesModule"],
        ],
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../app/GlobalFields */ "./src/app/GlobalFields.ts");
/* harmony import */ var _listingPage_listingPage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../listingPage/listingPage */ "./src/app/listingPage/listingPage.ts");
/* harmony import */ var _filterModal_filterModal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./filterModal/filterModal */ "./src/app/searchPage/filterModal/filterModal.ts");
/* harmony import */ var _services_Service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/Service */ "./src/app/services/Service.ts");
/* harmony import */ var _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ionic-native/status-bar/ngx */ "./node_modules/@ionic-native/status-bar/ngx/index.js");
/* harmony import */ var _mapModal_mapModal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./mapModal/mapModal */ "./src/app/searchPage/mapModal/mapModal.ts");
...
let SearchPage = class SearchPage {
    constructor(service, locationService, modalCtrl, statusBar, platform, translate, alertController) {
        this.service = service;
        this.locationService = locationService;
        this.modalCtrl = modalCtrl;
        this.statusBar = statusBar;
    ...
    loadData() {
        ...
        if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filtersSearch.location) { //address
    ...
    selectListingType(reloadOrder) {
        this.GlobalFields.filteredListings = undefined;
        const setLocation = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filtersSearch.location;
        this.GlobalFields.clearFilters();
        if (setLocation)
            _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filtersSearch.location = setLocation;
        this.GlobalFields.selectListingTypeDetail();
        console.log(this.GlobalFields.selectedTypeDetail);
    ...
    callServiceToGetFilteredListings() {
        this.service.getFilteredListings(true)
            ...
            console.log(data);
            this.loadingMoreData = false;
            if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filteredListings.length < 10 || data.length < 10)
                _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filtersSearch.noMorePage = true;
        });
    }
    onScrollHideHeader(event) {
        // console.log(event);
...
SearchPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./searchPage.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/searchPage/searchPage.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./searchPage.scss */ "./src/app/searchPage/searchPage.scss")).default]
    }),
...
let Service = class Service {
    constructor(http, cache, locationService, nativeStorage, statusBar, platform, googlePlus, fb, oneSignal, navController) {
        this.http = http;
        this.cache = cache;
        this.locationService = locationService;
    ...
    getWebSiteDetails() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1;
        let cacheKey = url;
    ...
    getCustomTaxonomies() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'taxonomies';
        let cacheKey = url;
        let request = this.http.get(url);
        return this.cache.loadFromObservable(cacheKey, request);
    }
    getRecentListings() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'search?limit=10&sort=latest&order=DESC';
        let cacheKey = url;
        let request = this.http.get(url);
        return this.cache.loadFromObservable(cacheKey, request);
    }
    ...
    getListingDetailsById(id) {
        ...
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'listing/' + id;
        let cacheKey = url;
        let request = this.http.get(url);
    ...
    getAllTypesListings() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2 + 'case27_listing_type';
        let cacheKey = url;
        let request = this.http.get(url);
        return this.cache.loadFromObservable(cacheKey, request);
    ...
    getAllTypeDetails() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'types';
        let cacheKey = url;
        let request = this.http.get(url);
        return this.cache.loadFromObservable(cacheKey, request);
    ...
    getAllTags() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'tags';
        let cacheKey = url;
        let request = this.http.get(url);
        return this.cache.loadFromObservable(cacheKey, request);
    ...
    getAllCategoriesListings() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'categories';
        let cacheKey = url;
        let request = this.http.get(url);
        return this.cache.loadFromObservable(cacheKey, request);
    ...
    getRegions() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'regions';
        let cacheKey = url;
        let request = this.http.get(url);
        return this.cache.loadFromObservable(cacheKey, request);
        //return this.http.get(Constants.url + this.suffix1 + this.suffix2 + 'region?&order=desc&orderby=count');
    }
    getListingCoverDetails(href) {
    ...
    getListingFiltered() {
        let cats = [];
        let categoriesParam = '';
        for (let i = 0; i < _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.categories.length; i++) {
            let cat = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.categories[i];
            if (cat.isChecked) {
    ...
    getListingsFilteredByType(id) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'search?limit=10&type=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].getListingTypeKeyById(id);
        let cacheKey = url;
        let request = this.http.get(url);
        return this.cache.loadFromObservable(cacheKey, request);
    }
    ...
    storeRecentViewedListing(listing) {
        ...
        if (!_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].recentViewedListings)
            _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].recentViewedListings = [];
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].recentViewedListings && _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].recentViewedListings.find(temp => temp.id == listing.id))
            return;
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].recentViewedListings.length == 10)
            _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].recentViewedListings[9] = listing;
        else
            _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].recentViewedListings.push(listing);
        this.nativeStorage.setItem('recentViewedListingCLA', { property: 'value', anotherProperty: _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].recentViewedListings })
    ...
    getFilteredListings(stats) {
        let page = '&page=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.currentPage;
        //type
        let type = 'type=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].getListingTypeKeyById(_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.selectedType);
        let stats_q = '';
        if (stats)
            stats_q = '&stats=1';
        //tags
        ...
        const selectedTags = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.tags.filter(el => el.isChecked);
        ...
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.region) {
            let r = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].regions.find(temp => temp.name == _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.region);
            if (r) {
        ...
        //order
        let order = '';
        if (!_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.order)
            _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.order = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].selectedTypeDetail.case27_listing_type_search_page.order.options[0].key;
        let orderObj = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].selectedTypeDetail.case27_listing_type_search_page.order.options.find(res => res.key == _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.order);
        if (orderObj) {
        ...
        let categories = '';
        for (let i = 0; i < _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.categories.length; i++) {
            let c = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].listingCategories.find(temp => temp.name == _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.categories[i]);
            console.log(_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].listingCategories);
            console.log(_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.categories[i]);
            console.log(c);
            if (c)
        ...
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.customTaxonomiesDropdownKeysOptions) {
            for (let i = 0; i < _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.customTaxonomiesDropdownKeysOptions.length; i++) {
                let tax = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.customTaxonomiesDropdownKeysOptions[i];
        ...
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.customFieldsDropdownKeysOptions) {
            for (let i = 0; i < _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.customFieldsDropdownKeysOptions.length; i++) {
                let cust = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.customFieldsDropdownKeysOptions[i];
        ...
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.customFieldsText) {
            for (let i = 0; i < _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.customFieldsText.length; i++) {
                let field = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.customFieldsText[i];
        ...
        //proximity
        let proximity = '';
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.range != undefined)
            proximity = '&proximity=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.range;
        //address
        let address = '';
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.location && _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.lat && _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.lng) //address specified and translated into lat lng
            address = '&lat=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.lat + '&lng=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.lng;
        //name
        let name = '';
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.name)
            address = '&title=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.name;
        //Generic search
        let search_keywords = '';
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.search_keywords)
            address = '&search_keywords=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].filtersSearch.search_keywords;
    ...
    getAllListings() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'search-geo';
        let cacheKey = url;
        let request = this.http.get(url);
        return this.cache.loadFromObservable(cacheKey, request);
    }
    getRegionsByType(listingTypeId) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'terms?taxonomy=region&format_levels=true&';
    ...
    initOneSignal() {
        ...
        this.oneSignal.handleNotificationOpened().subscribe((res) => {
            ...
            if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].isLoggedIn && res && res.notification.payload && res.notification.payload.additionalData
                ...
                this.getMsgsOfAChat(_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].senderMsgSelected.id).subscribe((data) => {
    ...
    getGeneralSearch(q) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix1 + this.suffix2CustomApp + 'quick-search?s=' + q;
        return this.http.get(url);
    }
    ...
    getNonce() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + 'get_nonce/?controller=authenticationcla&method=generate_auth_cookie';
        let request = this.http.get(url);
        return this.http.get(url, { responseType: 'text' });
    }
    getNonceRegistration() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + 'get_nonce/?controller=authenticationcla&method=register_user';
        let request = this.http.get(url);
        return this.http.get(url, { responseType: 'text' });
    }
    getNoncePswRecovery() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + 'get_nonce/?controller=authenticationcla&method=reset_password';
        let request = this.http.get(url);
        return this.http.get(url, { responseType: 'text' });
    }
    ...
    login(username, password, nonce) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix4 + 'generate_auth_cookie';
        let body = new FormData();
    ...
    registration(email, password, nonce) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix4 + 'register_user';
        let body = new FormData();
    ...
    storeProfile(profile) {
        ...
        this.nativeStorage.setItem('profileCLA', { property: 'value', anotherProperty: _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile })
            .then(() => console.log('Stored item!'), error => console.error('Error storing item', error));
    }
    ...
    getCurrentUserInfo() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix4 + 'get_currentuserinfo/?cookie=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie;
        let cacheKey = url;
        return this.http.get(url);
    }
    getMyListings(currentPage) {
        let page = '&page=' + currentPage;
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix6 + 'get_listings/?limit=20' + page + '&cookie=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie;
        return this.http.get(url);
    }
    getBookmarkedListings() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix5 + 'get_bookmarks/?cookie=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie;
        return this.http.get(url);
    }
    doBookmark(listing_id) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix5 + 'bookmark_listing/?cookie=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie + '&listing_id=' + listing_id;
        return this.http.get(url);
    }
    undoBookmark(listing_id) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix5 + 'remove_bookmark/?cookie=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie + '&listing_id=' + listing_id;
        return this.http.get(url);
    }
    postAReview(listingId, text, customFieldsStars, gallery, new_galleryFile, new_galleryName) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix6 + 'post_review';
        let body = new FormData();
    ...
    getRecipientsList() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix7 + 'post_review/?cookie=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie;
    }
    ...
    getChats() {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix7 + 'read_messages/?cookie=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie;
        return this.http.get(url);
    }
    getMsgsOfAChat(userID) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix7 + 'read_conversation/?cookie=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie;
        url = url + '&opponent_id=' + userID;
        return this.http.get(url);
    }
    markAsSeenChat(userID) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix7 + 'mark_as_seen/?cookie=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie;
        url = url + '&opponent_id=' + userID;
        return this.http.get(url);
    }
    sendMsg(message, receiver_id) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix7 + 'send_message';
        let body = new FormData();
        body.append('cookie', _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie);
    ...
    getMsgUsersByString(term) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix7 + 'get_recipients_list';
        let body = new FormData();
        body.append('cookie', _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie);
    ...
    saveListing(listing, fieldsTypeSelected, status) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix6 + 'save';
        let listingTypeSlug = listing._case27_listing_type;
        let listingType = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].listingTypesDetails.find(res => res.post_name == listingTypeSlug);
        let body = new FormData();
        body.append('cookie', _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie);
        ...
        fieldsTypeSelected.forEach(field => {
            if (field.show_in_submit_form) {
                ...
                if (field.type == 'term-select' && field.slug == 'job_category') {
                    for (let i = 0; i < _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.categories.length; i++) {
                        let c = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].listingCategories.find(temp => temp.name == _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.categories[i]);
                        if (c)
                ...
                if (field.type == 'term-select' && field.slug == 'job_tags') {
                    ...
                    const selectedTags = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.tags.filter(el => el.isChecked);
                    if (selectedTags) {
                        for (let i = 0; i < selectedTags.length; i++) {
                            let t = selectedTags[i];
                ...
                if (field.type == 'term-select' && field.slug == 'region') {
                    const selectedUIElements = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.regions.filter(el => el.isChecked);
                    if (selectedUIElements) {
                        let regions = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].regions;
                        for (let i = 0; i < _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.regions.length; i++) {
                            let uiElement = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.regions[i];
                ...
                if ((field.type == 'select' && field.slug == 'price_range') && _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.price_range) {
                    if (Array.isArray(_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.price_range))
                        _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.price_range.forEach(value => {
                            body.append(field.slug, value);
                        });
                    else
                        body.append(field.slug, _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.price_range);
                }
                //Working hours
                ...
                if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.customTaxonomiesDropdownKeysOptions) {
                    const customTax = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.customTaxonomiesDropdownKeysOptions.find(el => el.key == field.slug);
                ...
                if (_GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.customFieldsDropdownKeysOptions) {
                    const customField = _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].addForm.customFieldsDropdownKeysOptions.find(el => el.key == field.slug);
                    //If has options as array
    ...
    getMyListingDetailsById(id) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix6 + 'get/?cookie=' + _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie + '&listing_id=' + id;
        let cacheKey = url;
        let request = this.http.get(url);
        let TTL = 60 * 60 * 24; // 1 day
        return this.http.get(url);
    ...
    deleteListing(id) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix6 + 'delete';
        let body = new FormData();
        body.append('cookie', _GlobalFields__WEBPACK_IMPORTED_MODULE_4__["GlobalFields"].profile.cookie);
    ...
    */
    getPackagesPermission(listingTypeSelectedID) {
        let url = _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].url + this.suffix3 + this.suffix8 + 'list_by_type/?';
...
Service = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], ionic_cache__WEBPACK_IMPORTED_MODULE_5__["CacheService"], _LocationService__WEBPACK_IMPORTED_MODULE_6__["LocationService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _listingList_listingList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./listingList/listingList */ "./src/app/listingList/listingList.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/__ivy_ngcc__/fesm2015/ngx-translate-core.js");
/* harmony import */ var _loading_loading__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./loading/loading */ "./src/app/loading/loading.ts");
...
/* harmony import */ var _listingList_customFieldsToDisplay_customFieldsToDisplay__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./listingList/customFieldsToDisplay/customFieldsToDisplay */ "./src/app/listingList/customFieldsToDisplay/customFieldsToDisplay.ts");
/* harmony import */ var _shopPage_productList_productList__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./shopPage/productList/productList */ "./src/app/shopPage/productList/productList.ts");
...
SharedModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [
            _listingList_listingList__WEBPACK_IMPORTED_MODULE_3__["ListingList"],
            _loading_loading__WEBPACK_IMPORTED_MODULE_7__["Loading"],
            _listingList_customFieldsToDisplay_customFieldsToDisplay__WEBPACK_IMPORTED_MODULE_9__["CustomFieldsToDisplay"],
            _shopPage_productList_productList__WEBPACK_IMPORTED_MODULE_10__["ProductList"]
        ],
        exports: [
            _listingList_listingList__WEBPACK_IMPORTED_MODULE_3__["ListingList"],
            _listingList_customFieldsToDisplay_customFieldsToDisplay__WEBPACK_IMPORTED_MODULE_9__["CustomFieldsToDisplay"],
...
ProductList = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./productList.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shopPage/productList/productList.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./productList.scss */ "./src/app/shopPage/productList/productList.scss")).default]
    }),
...
/* harmony import */ var _tabs_modalAdd_modalAdd__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../tabs/modalAdd/modalAdd */ "./src/app/tabs/modalAdd/modalAdd.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
SideMenu = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./sideMenu.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/sideMenu/sideMenu.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./sideMenu.scss */ "./src/app/sideMenu/sideMenu.scss")).default]
    }),
...
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/__ivy_ngcc__/fesm2015/ngx-translate-core.js");
/* harmony import */ var _entities_listing__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../entities/listing */ "./src/app/entities/listing.ts");
/* harmony import */ var _services_Service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/Service */ "./src/app/services/Service.ts");
...
/* harmony import */ var _entities_FiltersSearch__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../entities/FiltersSearch */ "./src/app/entities/FiltersSearch.ts");
...
let ModalAddNode = class ModalAddNode {
    constructor(service, wooCommerceService, viewCtrl, imagePicker, translate, alertController, base64, platform) {
        ...
        _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm = this.GlobalFields.duplicateObj(_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].filtersSearch);
        // is edit
        if (this.GlobalFields.listingToEdit && this.GlobalFields.listingToEdit.id) {
            this.newListing = this.GlobalFields.listingToEdit;
            if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].listingTypesDetails.find(res => res.post_name == this.GlobalFields.listingToEdit._case27_listing_type)) {
                this.selectedType = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].listingTypesDetails.find(res => res.post_name == this.GlobalFields.listingToEdit._case27_listing_type).ID;
                this.selectListingType();
    ...
    iniFormAd() {
        ...
        _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.work_hours.timezone = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].site_details ? _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].site_details.timezone : undefined;
        ...
        for (let key in this.GlobalFields.listingCustomTaxonomies) {
            if (key != 'region') {
                ...
                if (this.fieldsTypeSelected.find(el => el.slug == key)) {
                    ...
                    _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.customTaxonomiesDropdownKeysOptions.push({ key: key, options: opts, selected: selected });
                }
            }
        }
        //array of custom fields for dropdowns
        _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].listingCustomFieldKeys.forEach(key => {
            ...
            if (field && (field.type == 'term-select' || field.type == 'select' || field.type == 'multiselect')) {
                ...
                if (this.newListing && this.newListing.id && this.newListing[key])
                    selected = this.newListing[key];
                _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.customFieldsDropdownKeysOptions.push({ key: field.slug, options: field.options, selected: selected });
            }
        });
    }
    selectListingType() {
        this.selectedTypeDetail = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].listingTypesDetails.find(res => res.ID == this.selectedType);
    ...
    toStringCategories() {
        if (!_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.categories || _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.categories.length == 0)
            return '';
        else if (_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.categories.length > 3)
            return _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.categories.length + ' selected';
        else
            return _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.categories.toString();
    }
    toStringTaxonomies(key) {
        let tax = _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].getCustomTaxonomiesByKey(key);
        if (tax) {
            /* if (!tax.selected || tax.selected.length == 0)
                 return "";
             else if (tax.selected.length > 3)
    ...
    */
    ...
    isVoidField(field) {
        if (!field)
            return true;
        if (field.slug == 'job_category' && _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.categories.length == 0)
            return true;
        if (field.slug == 'job_category')
            return false;
        if (field.slug == 'job_tags' && _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.tags.length == 0)
            return true;
        if (field.slug == 'job_tags')
            return false;
        if (field.slug == 'region' && _app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.regions.length == 0)
            return true;
        if (field.slug == 'region')
            return false;
        if (field.slug == 'price_range' && !_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].addForm.price_range)
            return true;
        ...
        if (!field.is_custom && field.type == 'term-select' && !_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].getCustomTaxonomiesByKeyAddForm(field.slug).selected)
            return true;
        //Custom select OR multiselect field
        if (field.is_custom && (field.type == 'select' || field.type == 'multiselect') && !_app_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].getCustomFieldsByKeyAddForm(field.slug).selected)
            return true;
        //custom field
    ...
    addWorkHours() {
        if (!this.newListing.work_hours[this.selectedDay])
            this.newListing.work_hours[this.selectedDay] = new _entities_FiltersSearch__WEBPACK_IMPORTED_MODULE_11__["WorkHoursDay"]();
...
ModalAddNode = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'modal',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./modalAdd.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/tabs/modalAdd/modalAdd.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./modalAdd.scss */ "./src/app/tabs/modalAdd/modalAdd.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_Service__WEBPACK_IMPORTED_MODULE_8__["Service"], _services_WooCommerceService__WEBPACK_IMPORTED_MODULE_10__["WooCommerceService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _ionic_native_image_picker_ngx__WEBPACK_IMPORTED_MODULE_4__["ImagePicker"],
...
GoogleMapsAutocomplete = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./googleMapsAutocomplete.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/utilities/googleMapsAutocomplete/googleMapsAutocomplete.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./googleMapsAutocomplete.scss */ "./src/app/utilities/googleMapsAutocomplete/googleMapsAutocomplete.scss")).default]
    }),
...
/* harmony import */ var _googleMapsAutocomplete_googleMapsAutocomplete__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./googleMapsAutocomplete/googleMapsAutocomplete */ "./src/app/utilities/googleMapsAutocomplete/googleMapsAutocomplete.ts");
/* harmony import */ var ionic_image_loader__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ionic-image-loader */ "./node_modules/ionic-image-loader/__ivy_ngcc__/fesm2015/ionic-image-loader.js");
/* harmony import */ var agm_overlays__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! agm-overlays */ "./node_modules/agm-overlays/__ivy_ngcc__/fesm2015/agm-overlays.js");
...
/* harmony import */ var agm_direction__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! agm-direction */ "./node_modules/agm-direction/__ivy_ngcc__/fesm2015/agm-direction.js");
...
UtilitiesModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
        imports: [
            ...
            ionic_image_loader__WEBPACK_IMPORTED_MODULE_8__["IonicImageLoader"].forRoot(),
        ...
        exports: [
            _googleMapsAutocomplete_googleMapsAutocomplete__WEBPACK_IMPORTED_MODULE_7__["GoogleMapsAutocomplete"],
            agm_overlays__WEBPACK_IMPORTED_MODULE_9__["AgmOverlays"],
...
module.exports = __webpack_require__(/*! /Users/emmanuelketchabepa/Desktop/customlistingapp_v1_6_2/app/src/main.ts */"./src/main.ts");
