...
ClusterManager.ɵfac = function ClusterManager_Factory(t) { return new (t || ClusterManager)(ɵngcc0.ɵɵinject(ɵngcc1.GoogleMapsAPIWrapper), ɵngcc0.ɵɵinject(ɵngcc0.NgZone)); };
ClusterManager.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ClusterManager, factory: ClusterManager.ɵfac });
ClusterManager.ctorParameters = () => [
    { type: GoogleMapsAPIWrapper },
    { type: NgZone }
];
ClusterManager = __decorate([ __metadata("design:paramtypes", [GoogleMapsAPIWrapper, NgZone])
], ClusterManager);
...
AgmMarkerCluster.ɵfac = function AgmMarkerCluster_Factory(t) { return new (t || AgmMarkerCluster)(ɵngcc0.ɵɵdirectiveInject(ClusterManager)); };
AgmMarkerCluster.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: AgmMarkerCluster, selectors: [["agm-marker-cluster"]], inputs: { gridSize: "gridSize", maxZoom: "maxZoom", zoomOnClick: "zoomOnClick", averageCenter: "averageCenter", minimumClusterSize: "minimumClusterSize", styles: "styles", calculator: "calculator", imagePath: "imagePath", imageExtension: "imageExtension" }, outputs: { clusterClick: "clusterClick" }, features: [ɵngcc0.ɵɵProvidersFeature([
            ClusterManager,
...
AgmMarkerCluster = __decorate([ __metadata("design:paramtypes", [ClusterManager])
], AgmMarkerCluster);

let AgmJsMarkerClustererModule = class AgmJsMarkerClustererModule {
};
AgmJsMarkerClustererModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: AgmJsMarkerClustererModule });
AgmJsMarkerClustererModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function AgmJsMarkerClustererModule_Factory(t) { return new (t || AgmJsMarkerClustererModule)(); }, imports: [[AgmCoreModule]] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ClusterManager, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc1.GoogleMapsAPIWrapper }, { type: ɵngcc0.NgZone }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AgmMarkerCluster, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: ClusterManager }]; }, { clusterClick: [{
            type: Output
        }], gridSize: [{
            type: Input
        }], maxZoom: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AgmJsMarkerClustererModule, { declarations: function () { return [AgmMarkerCluster]; }, imports: function () { return [AgmCoreModule]; }, exports: function () { return [AgmMarkerCluster]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AgmJsMarkerClustererModule, [{
        type: NgModule,
        args: [{
