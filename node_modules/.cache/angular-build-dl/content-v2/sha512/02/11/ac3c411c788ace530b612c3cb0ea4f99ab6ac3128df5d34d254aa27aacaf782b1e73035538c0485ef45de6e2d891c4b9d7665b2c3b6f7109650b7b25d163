...
let BookmarksPage = class BookmarksPage {
    constructor(service, translate, navController, dialogs, platform, geolocation, nativeGeocoder, alertController, router, modalCtrl) {
    ...
    undoBookmark(id) {
        this.loadingSection = true;
        this.service.undoBookmark(id).subscribe((data) => {
            this.getBookmarkedListings();
        }, err => {
            this.service.refreshCookie();
        });
...
/* harmony import */ var _settingsPage_settingsPage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./settingsPage/settingsPage */ "./src/app/menuPage/settingsPage/settingsPage.ts");
...
/* harmony import */ var _loginComponent_loginComponent_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./loginComponent/loginComponent.module */ "./src/app/menuPage/loginComponent/loginComponent.module.ts");
/* harmony import */ var _myListingsPage_myListingsPage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./myListingsPage/myListingsPage */ "./src/app/menuPage/myListingsPage/myListingsPage.ts");
/* harmony import */ var _bookmarksPage_bookmarksPage__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./bookmarksPage/bookmarksPage */ "./src/app/menuPage/bookmarksPage/bookmarksPage.ts");
/* harmony import */ var _notificationsPage_notificationsPage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./notificationsPage/notificationsPage */ "./src/app/menuPage/notificationsPage/notificationsPage.ts");
...
MenuPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["NgModule"])({
        imports: [
            ...
            _loginComponent_loginComponent_module__WEBPACK_IMPORTED_MODULE_10__["LoginComponentModule"]
        ],
...
let MenuPage = class MenuPage {
    constructor(service, translate, navController) {
        this.service = service;
        this.translate = translate;
        this.navController = navController;
...
MenuPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_Service__WEBPACK_IMPORTED_MODULE_2__["Service"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["NavController"]])
], MenuPage);
...
/* harmony import */ var _tabs_modalAdd_modalAdd__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../tabs/modalAdd/modalAdd */ "./src/app/tabs/modalAdd/modalAdd.ts");
...
let MyListingsPage = class MyListingsPage {
    ...
    getMyListings() {
        if (_GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].isLoggedIn) {
            ...
            this.service.getMyListings(this.currentPage).subscribe((data) => {
    ...
    editListing(listing) {
        ...
        this.service.getMyListingDetailsById(listing.id).subscribe((data) => {
            if (data) {
                ...
                buttons: [
                    {
                        ...
                        handler: () => {
                            this.GlobalFields.loadingSoft = true;
                            this.service.deleteListing(listing.id).subscribe((data) => {
...
MyListingsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_Service__WEBPACK_IMPORTED_MODULE_5__["Service"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["NavController"],
...
let SettingsPage = class SettingsPage {
    constructor(service, translate, navController, dialogs, platform, geolocation, nativeGeocoder, alertController, themeService, locationService, inAppBrowser, appVersion) {
        this.service = service;
        this.translate = translate;
        this.navController = navController;
        this.dialogs = dialogs;
    ...
    clearCache() {
        ...
        setTimeout(() => {
            _GlobalFields__WEBPACK_IMPORTED_MODULE_3__["GlobalFields"].init(this.service, this.dialogs, this.platform, this.geolocation, this.nativeGeocoder, this.alertController, this.translate, this.themeService, this.locationService);
        }, 200);
    }
    setLang(lang) {
...
SettingsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_Service__WEBPACK_IMPORTED_MODULE_4__["Service"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["NavController"],
        ...
        _services_LocationService__WEBPACK_IMPORTED_MODULE_10__["LocationService"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_11__["InAppBrowser"], _ionic_native_app_version_ngx__WEBPACK_IMPORTED_MODULE_12__["AppVersion"]])
], SettingsPage);
